...
class TestExerciseModel:
    ...
    def test_get_by_user(self, db_session, test_user):
        ...
        exercise1 = Exercise(
            user_id=test_user.id, type=ExerciseType.RUNNING, metrics={"distance": 5.0, "duration": 30}
        )
        exercise2 = Exercise(
            user_id=test_user.id, type=ExerciseType.CYCLING, metrics={"distance": 10.0, "duration": 60}
        )
